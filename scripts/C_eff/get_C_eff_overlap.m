function [C_eff_f, C_eff_r,C_eff_f_err, C_eff_r_err] = get_C_eff_overlap( all_pts_f, all_pts_r, just_SO3 );
% [C_eff_f, C_eff_r,C_eff_f_err, C_eff_r_err] = get_C_eff_overlap( all_pts_f, all_pts_r );
%
%
% Inputs
