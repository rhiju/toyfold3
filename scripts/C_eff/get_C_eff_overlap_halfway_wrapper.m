function [C_eff_overlap_halfway,C_eff_overlap_halfway_error] = get_C_eff_overlap_halfway_wrapper( N_overlap, all_pts_f, all_pts_r, N_overlap_offset );
% [C_eff_overlap_halfway,C_eff_overlap_halfway_error] = get_C_eff_overlap_halfway_wrapper( N_overlap, all_pts_f, all_pts_r, N_overlap_offset );
%
% Compute efficiently  C_eff based on overlap of
%  distributions going N/2 steps in forward and in reverse directions 
%
% Note GET_C_EFF_OVERLAP_HALFWAY is a simpler function.
%
